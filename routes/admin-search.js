...
next()
  ...
  router.get('/',checkLoginUser, function(req,res, next){
    var loginUser = req.session.adminName
        ...
        res.render('admin/adminHeader',{title:'E-farming Store',success:'',loginUser:loginUser})
  })
  ...
  router.post('/',checkLoginUser, function(req, res, next){
    ...
    productModel.find(fltrParameter).exec(function(err,data){
        if(err) throw err
        res.render('admin/admin-view-product',{title:'E-farming Store', prodectRecord:data,pages:pages,loginUser:loginUser })
    })
