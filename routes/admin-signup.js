...
function checkEmail(req, res, next){
    ...
    checkExitEmail.exec((err, data)=>{
      if (err) throw err;
      if (data) {
        return res.render('admin/signup', { title: 'E-farming Store', msg:"Email Already Exit" });
      }
      next()
    })
  }
  ...
  function checkUserName(req, res, next){
    ...
    checkExitUserName.exec((err, data)=>{
      if (err) throw err;
      if (data) {
        return res.render('admin/signup', { title: 'E-farming Store', msg:"UserName Already Exit" });
      }
      next()
    })
  }
  ...
  router.get('/',checkLoginUser, function(req,res, next){
        res.render('admin/signup',{title:'E-farming Store',msg:''})
  })
  ...
  router.post('/',checkLoginUser, checkUserName,checkEmail, function(req, res, next) {
    ...
    if(password != confpassword) {
      res.render('admin/signup', { title: 'E-farming Store', msg:'Password Not Matched!' });
    }
    else {
      ...
      signupDetails.save((err,doc)=>{
        if (err) throw err;
        res.render('admin/signup', { title: 'E-farming Store', msg:'User Register Successfully' });
      });
    }
