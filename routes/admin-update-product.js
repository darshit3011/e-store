...
next()
  ...
  router.get('/edit/:id',checkLoginUser, function(req, res, next) {
    ...
    productModel.findById({_id:id}).exec(function(err,data){
        if(err) throw err;
        res.render('admin/edit_product', { title:'E-farming Store',success:'', productRecord:data,loginUser:loginUser,categoryRecord:catRec});
    })
  ...
  router.post('/:id',checkLoginUser,upload, function(req, res, next) {
    ...
    productModel.findById({_id:id}).exec(function(err,data){
        if(err) throw err;
        res.render('admin/edit_product', { title:'E-farming Store',success:'', productRecord:data,loginUser:loginUser,categoryRecord:catRec, success:'Updated Successfully'});
    })
    })
