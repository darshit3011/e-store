  ...
  router.get('/', function(req,res, next){
    ...
    contact.sort({created_at: -1}).limit(1).exec(function(err,contactData){
      ...
      category.exec(function(err, data){
        res.render('client/contact_us',{title:'E-farming Store',contactRecord:contactData,categoryRecord:data,success:'',loginUserInfo:loginUser,userData:userdata})
      })
    })
  })
  ...
  router.post('/', function(req, res, next){
    ...
    contactDetails.save(function(err, data1){
      ...
      contact.exec(function(err,data){
        if(err) throw err
        res.render('client/contact_us',{title:'E-farming Store',contactRecord:data,categoryRecord:cat, success:'Message send successfully',loginUserInfo:loginUser,userData:userdata})
